...
public final class RebalancingParams extends ReflectiveConfigGroup {
	...
	protected void checkConsistency(Config config) {
		...
		Preconditions.checkArgument(getMinServiceTime() > getMaxTimeBeforeIdle(),
				de.mpi.ds.matsim_bimodal.drt.optimizer.rebalancing.RebalancingParams.MIN_SERVICE_TIME + "must be greater than" + de.mpi.ds.matsim_bimodal.drt.optimizer.rebalancing.RebalancingParams.MAX_TIME_BEFORE_IDLE);
	}
