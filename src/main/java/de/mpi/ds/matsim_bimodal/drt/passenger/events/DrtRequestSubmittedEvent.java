...
public class DrtRequestSubmittedEvent extends PassengerRequestSubmittedEvent {
	...
	public static de.mpi.ds.matsim_bimodal.drt.passenger.events.DrtRequestSubmittedEvent convert(GenericEvent event) {
		...
		return new de.mpi.ds.matsim_bimodal.drt.passenger.events.DrtRequestSubmittedEvent(time, mode, requestId, personId, fromLinkId, toLinkId, unsharedRideTime,
