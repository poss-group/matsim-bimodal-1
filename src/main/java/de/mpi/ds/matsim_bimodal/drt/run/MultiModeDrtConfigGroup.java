...
public final class MultiModeDrtConfigGroup extends ReflectiveConfigGroup implements MultiModal<DrtConfigGroup> {
	 ...
	 */
	public static de.mpi.ds.matsim_bimodal.drt.run.MultiModeDrtConfigGroup get(Config config) {
		return (de.mpi.ds.matsim_bimodal.drt.run.MultiModeDrtConfigGroup)config.getModule(GROUP_NAME);
	}
