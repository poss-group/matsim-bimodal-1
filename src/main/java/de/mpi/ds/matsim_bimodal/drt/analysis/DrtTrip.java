...
public class DrtTrip implements Comparable<de.mpi.ds.matsim_bimodal.drt.analysis.DrtTrip> {
	...
	@Override
	public int compareTo(de.mpi.ds.matsim_bimodal.drt.analysis.DrtTrip o) {
