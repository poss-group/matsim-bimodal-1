...
public class TransportProblem<P, C> {
	public static List<Flow<DrtZone, DrtZone>> solveForVehicleSurplus(
		...
		return new de.mpi.ds.matsim_bimodal.drt.optimizer.rebalancing.mincostflow.TransportProblem<DrtZone, DrtZone>(de.mpi.ds.matsim_bimodal.drt.optimizer.rebalancing.mincostflow.TransportProblem::calcStraightLineDistance).solve(supply, demand);
	}
