...
public class EqualRebalancableVehicleDistributionTargetCalculator implements RebalancingTargetCalculator {
	private static final Logger log = Logger.getLogger(de.mpi.ds.matsim_bimodal.drt.optimizer.rebalancing.targetcalculator.EqualRebalancableVehicleDistributionTargetCalculator.class);
