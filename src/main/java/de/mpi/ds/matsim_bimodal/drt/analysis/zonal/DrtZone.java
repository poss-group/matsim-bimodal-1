...
public class DrtZone {
	public static de.mpi.ds.matsim_bimodal.drt.analysis.zonal.DrtZone createDummyZone(String id, List<Link> links, Coord centroid) {
		return new de.mpi.ds.matsim_bimodal.drt.analysis.zonal.DrtZone(id, null, links, centroid);
	}
