...
public final class EqualVehiclesToPopulationRatioTargetCalculator implements RebalancingTargetCalculator {
	...
	private static final Logger log = Logger.getLogger(de.mpi.ds.matsim_bimodal.drt.optimizer.rebalancing.targetcalculator.EqualVehiclesToPopulationRatioTargetCalculator.class);
