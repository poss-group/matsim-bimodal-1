...
package de.mpi.ds.matsim_bimodal.drt.passenger;
...
public class DrtRequest implements PassengerRequest {
	...
	public static Builder newBuilder(de.mpi.ds.matsim_bimodal.drt.passenger.DrtRequest copy) {
	...
	public static final class Builder {
		...
		public de.mpi.ds.matsim_bimodal.drt.passenger.DrtRequest build() {
			return new de.mpi.ds.matsim_bimodal.drt.passenger.DrtRequest(this);
		}
	}
}
