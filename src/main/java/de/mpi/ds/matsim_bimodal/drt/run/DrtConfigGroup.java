...
import de.mpi.ds.matsim_bimodal.drt.analysis.zonal.DrtZonalSystemParams;
import de.mpi.ds.matsim_bimodal.drt.optimizer.insertion.DrtInsertionSearchParams;
import de.mpi.ds.matsim_bimodal.drt.optimizer.insertion.ExtensiveInsertionSearchParams;
import de.mpi.ds.matsim_bimodal.drt.optimizer.insertion.SelectiveInsertionSearchParams;
...
public final class DrtConfigGroup extends ReflectiveConfigGroup implements Modal {
	private static final Logger log = Logger.getLogger(de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup.class);

	public static final String GROUP_NAME = "drt";

	public static de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup getSingleModeDrtConfig(Config config) {
		Collection<de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup> drtConfigGroups = MultiModeDrtConfigGroup.get(config).getModalElements();
	 ...
	 */
	@StringSetter(MODE)
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setMode(String mode) {
		this.mode = mode;
		return this;
	}
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setUseModeFilteredSubnetwork(boolean useModeFilteredSubnetwork) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setStopDuration(double stopDuration) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setMaxWaitTime(double maxWaitTime) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setDrtServiceAreaShapeFile(String getDrtServiceAreaShapeFile) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setMaxTravelTimeAlpha(double maxTravelTimeAlpha) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setMaxTravelTimeBeta(double maxTravelTimeBeta) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setRejectRequestIfMaxWaitOrTravelTimeViolated(
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setChangeStartLinkToLastLinkInSchedule(boolean changeStartLinkToLastLinkInSchedule) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setVehiclesFile(String vehiclesFile) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setIdleVehiclesReturnToDepots(boolean idleVehiclesReturnToDepots) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setOperationalScheme(OperationalScheme operationalScheme) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setTransitStopFile(String transitStopFile) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setMaxWalkDistance(double maximumWalkDistance) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setEstimatedDrtSpeed(double estimatedSpeed) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setEstimatedBeelineDistanceFactor(double estimatedBeelineDistanceFactor) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setPlotDetailedCustomerStats(boolean plotDetailedCustomerStats) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setNumberOfThreads(final int numberOfThreads) {
	...
	public de.mpi.ds.matsim_bimodal.drt.run.DrtConfigGroup setAdvanceRequestPlanningHorizon(double advanceRequestPlanningHorizon) {
