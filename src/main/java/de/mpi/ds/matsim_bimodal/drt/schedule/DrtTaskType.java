...
import de.mpi.ds.matsim_bimodal.drt.schedule.DrtTaskBaseType;
...
public class DrtTaskType implements Task.TaskType {
	...
	public final boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof de.mpi.ds.matsim_bimodal.drt.schedule.DrtTaskType))
			return false;
		de.mpi.ds.matsim_bimodal.drt.schedule.DrtTaskType that = (de.mpi.ds.matsim_bimodal.drt.schedule.DrtTaskType)o;
