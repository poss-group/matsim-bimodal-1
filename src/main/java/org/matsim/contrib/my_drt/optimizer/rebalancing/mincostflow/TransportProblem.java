...
public class TransportProblem<P, C> {
	public static List<Flow<org.matsim.contrib.my_drt.analysis.zonal.DrtZone, org.matsim.contrib.my_drt.analysis.zonal.DrtZone>> solveForVehicleSurplus(
			List<AggregatedMinCostRelocationCalculator.DrtZoneVehicleSurplus> vehicleSurplus) {
		List<Pair<org.matsim.contrib.my_drt.analysis.zonal.DrtZone, Integer>> supply = new ArrayList<>();
		List<Pair<org.matsim.contrib.my_drt.analysis.zonal.DrtZone, Integer>> demand = new ArrayList<>();
		...
		return new TransportProblem<org.matsim.contrib.my_drt.analysis.zonal.DrtZone, org.matsim.contrib.my_drt.analysis.zonal.DrtZone>(TransportProblem::calcStraightLineDistance).solve(supply, demand);
	}

	private static int calcStraightLineDistance(org.matsim.contrib.my_drt.analysis.zonal.DrtZone zone1, DrtZone zone2) {
