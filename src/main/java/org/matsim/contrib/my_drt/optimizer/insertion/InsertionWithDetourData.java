...
public class InsertionWithDetourData<D> {
	private final InsertionGenerator.Insertion insertion;
	...
	InsertionWithDetourData(InsertionGenerator.Insertion insertion, D detourToPickup, D detourFromPickup, D detourToDropoff,
							D detourFromDropoff) {
	...
	public InsertionGenerator.Insertion getInsertion() {
		return insertion;
	}
	...
	public InsertionGenerator.InsertionPoint getPickup() {
		return insertion.pickup;
	}

	public InsertionGenerator.InsertionPoint getDropoff() {
