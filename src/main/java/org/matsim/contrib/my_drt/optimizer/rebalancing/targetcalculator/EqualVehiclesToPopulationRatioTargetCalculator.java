...
public final class EqualVehiclesToPopulationRatioTargetCalculator implements RebalancingTargetCalculator {
	...
	private final Map<org.matsim.contrib.my_drt.analysis.zonal.DrtZone, Integer> activitiesPerZone;
	private final int totalNrActivities;

	public EqualVehiclesToPopulationRatioTargetCalculator(org.matsim.contrib.my_drt.analysis.zonal.DrtZonalSystem zonalSystem, Population population,
	...
	private Map<org.matsim.contrib.my_drt.analysis.zonal.DrtZone, Integer> countFirstActsPerZone(DrtZonalSystem zonalSystem, Population population) {
	...
	@Override
	public ToDoubleFunction<org.matsim.contrib.my_drt.analysis.zonal.DrtZone> calculate(double time,
