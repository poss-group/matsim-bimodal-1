...
public class VehicleData {
	...
	public static class Stop implements Waypoint {
		public final org.matsim.contrib.my_drt.schedule.DrtStopTask task;
		...
		private double calcLatestArrivalTime() {
			return getMaxTimeConstraint(
					task.getDropoffRequests().values().stream().mapToDouble(org.matsim.contrib.my_drt.passenger.DrtRequest::getLatestArrivalTime),
					task.getBeginTime());
		}
