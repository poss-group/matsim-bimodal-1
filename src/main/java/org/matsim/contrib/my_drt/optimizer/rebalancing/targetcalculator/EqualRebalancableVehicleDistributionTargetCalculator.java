...
public class EqualRebalancableVehicleDistributionTargetCalculator implements RebalancingTargetCalculator {
	...
	private final org.matsim.contrib.my_drt.optimizer.rebalancing.demandestimator.ZonalDemandEstimator demandEstimator;
	...
	public ToDoubleFunction<org.matsim.contrib.my_drt.analysis.zonal.DrtZone> calculate(double time,
		...
		ToDoubleFunction<org.matsim.contrib.my_drt.analysis.zonal.DrtZone> currentDemandEstimator = demandEstimator.getExpectedDemandForTimeBin(time);
