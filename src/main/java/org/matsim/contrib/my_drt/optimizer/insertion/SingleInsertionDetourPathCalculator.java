...
import static org.matsim.contrib.my_drt.optimizer.insertion.InsertionGenerator.Insertion;
...
public class SingleInsertionDetourPathCalculator implements DetourPathCalculator, MobsimBeforeCleanupListener {
	...
	@Override
	public org.matsim.contrib.my_drt.optimizer.insertion.DetourData<PathData> calculatePaths(DrtRequest drtRequest, List<Insertion> filteredInsertions) {
