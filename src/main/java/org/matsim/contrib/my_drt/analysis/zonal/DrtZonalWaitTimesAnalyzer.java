...
import org.matsim.contrib.my_drt.passenger.events.DrtRequestSubmittedEventHandler;
...
public final class DrtZonalWaitTimesAnalyzer implements IterationEndsListener, DrtRequestSubmittedEventHandler {
	...
	private final org.matsim.contrib.my_drt.analysis.DrtRequestAnalyzer requestAnalyzer;
	private final org.matsim.contrib.my_drt.analysis.zonal.DrtZonalSystem zones;
	private Map<Id<Request>, DrtRequestSubmittedEvent> submittedRequests = new HashMap<>();

	public DrtZonalWaitTimesAnalyzer(DrtConfigGroup configGroup, org.matsim.contrib.my_drt.analysis.DrtRequestAnalyzer requestAnalyzer,
	...
	private Map<String, DescriptiveStatistics> createZonalStats(String delimiter) {
		...
		for (DrtRequestAnalyzer.PerformedRequestEventSequence data : requestAnalyzer.getPerformedRequestSequences().values()) {
