...
public class DrtTaskType implements Task.TaskType {
	...
	private final Optional<org.matsim.contrib.my_drt.schedule.DrtTaskBaseType> baseType;

	private final int hash;

	public DrtTaskType(@NotNull org.matsim.contrib.my_drt.schedule.DrtTaskBaseType baseType) {
		this.name = baseType.name();
		this.baseType = Optional.of(baseType);
		this.hash = Objects.hash(name, baseType);
	}

	public DrtTaskType(String name, @Nullable org.matsim.contrib.my_drt.schedule.DrtTaskBaseType baseType) {
		this.name = name;
