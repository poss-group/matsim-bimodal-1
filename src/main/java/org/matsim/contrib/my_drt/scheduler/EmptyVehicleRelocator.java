...
import org.matsim.contrib.my_drt.schedule.DrtTaskType;
...
public class EmptyVehicleRelocator {
	public static final org.matsim.contrib.my_drt.schedule.DrtTaskType RELOCATE_VEHICLE_TASK_TYPE = new DrtTaskType("RELOCATE", DrtTaskBaseType.DRIVE);
	...
	public void relocateVehicle(DvrpVehicle vehicle, Link link) {
		org.matsim.contrib.my_drt.schedule.DrtStayTask currentTask = (org.matsim.contrib.my_drt.schedule.DrtStayTask)vehicle.getSchedule().getCurrentTask();
	...
	private void relocateVehicleImpl(DvrpVehicle vehicle, VrpPathWithTravelData vrpPath) {
		...
		org.matsim.contrib.my_drt.schedule.DrtStayTask stayTask = (DrtStayTask)schedule.getCurrentTask();
