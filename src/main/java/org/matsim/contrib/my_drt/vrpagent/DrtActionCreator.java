...
package org.matsim.contrib.my_drt.vrpagent;
...
public class DrtActionCreator implements VrpAgentLogic.DynActionCreator {
	...
	public DynAction createAction(DynAgent dynAgent, DvrpVehicle vehicle, double now) {
		...
		switch (org.matsim.contrib.my_drt.schedule.DrtTaskBaseType.getBaseType(task)) {
			case DRIVE:
				return legFactory.create(vehicle);

			case STOP:
				org.matsim.contrib.my_drt.schedule.DrtStopTask t = (DrtStopTask)task;
