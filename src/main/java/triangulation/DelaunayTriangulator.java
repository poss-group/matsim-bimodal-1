...
public class DelaunayTriangulator {
    ...
    public void triangulate() throws NotEnoughPointsException {
        ...
        for (int i = 0; i < pointSet.size(); i++) {
            ...
            if (triangle == null) {
                ...
                Triangle2D second = triangleSoup.findNewNeighbour(first, edge);
    ...
    private void legalizeEdge(Triangle2D triangle, Edge2D edge, Vector2D newVertex) {
        //TODO why have to use newNeighbourMethod?
        Triangle2D neighbourTriangle = triangleSoup.findNewNeighbour(triangle, edge);
//        Triangle2D bla = triangleSoup.findNeighbour(triangle, edge);
//
//        Triangle2D neighbourTriangle2 = triangleSoup.findNewNeighbour(triangle, edge);
//        Triangle2D bla2 = triangleSoup.findNeighbour(triangle, edge);
        /**
         * If the triangle has a neighbor, then legalize the edge
         */
//        if (bla != neighbourTriangle) {
//            System.out.printf("strange");
//        }
    ...
    public TriangleSoup getTriangleSoup() {return this.triangleSoup;}
