...
public class TriangleSoup {
    ...
    public Triangle2D findNeighbour(Triangle2D triangle, Edge2D edge) {
        if (triangle.ab.compareTo(edge) == 0) {
            if (triangle.nab == null) {
                triangle.nab = findNewNeighbour(triangle, triangle.ab);
            }
            return triangle.nab;
        }
        if (triangle.bc.compareTo(edge) == 0) {
            if (triangle.nbc == null) {
                triangle.nbc = findNewNeighbour(triangle, triangle.bc);
            }
            return triangle.nbc;
        }
        if (triangle.ca.compareTo(edge) == 0) {
            if (triangle.nca == null) {
                triangle.nca = findNewNeighbour(triangle, triangle.ca);
            }
            return triangle.nca;
        }
        return null;
    ...
    public Triangle2D findNewNeighbour(Triangle2D triangle, Edge2D edge) {
